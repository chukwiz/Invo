...
import Quote from '../../../components/Testimonial/Quote/Quote';
    ...
    <ul className="navbar-nav ml-auto" style={{marginRight:"40px"}}>
      ...
      <li className="nav-item dropdown">
        ...
        <div className="dropdown-menu " aria-labelledby="navbarDropdownMenuLink">
          ...
          <a className="dropdown-item active" href="/testimony">
            Testimonials
          </a>
        </div>
      </li>
            ...
            {/* <div className="breadcrumb-container" style={{borderTop: '2px solid #f1f1f1'}}>
              <div className="container">
                <ol className="breadcrumb">
                  ...
                  <li><a href="funding-methods.html">Funding</a></li>
                  <li className="active">LMFX Bonus Offerings</li>
                </ol>
              </div>
            </div> */}
